...
function onEvent(name, value1, value2)
	if name == 'Camera Flash' or name == 'Camera_Flash' and flashingLights then
		...
		local camera, isForced, alpha, ease, blend = parseCameraValue(value1)
